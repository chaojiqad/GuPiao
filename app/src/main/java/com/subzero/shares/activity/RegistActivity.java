...
public class RegistActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mPhoneNum = (EditText) findViewById(R.id.et_ac_regist_phone_num);
        mCheckNum = (EditText) findViewById(R.id.et_ac_regist_check_num);
        mRetPwd = (EditText) findViewById(R.id.et_ac_regist_pwd);
        mGetCheckNum = (TimeDownButton) findViewById(R.id.btn_ac_regist_check_num);
        mOk = (Button) findViewById(R.id.btn_ac_regist_regist);
        ...
        mGetCheckNum.setOnClickTimeDownButtonListener(new TimeDownButton.OnClickTimeDownButtonListener() {
            ...
            public void onClick() {
                if (!StringUtils.isPhoneNum(mPhoneNum.getText().toString().trim())) {
                    Toast.makeText(RegistActivity.this, "手机号码的格式不正确", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_ac_regist_regist:
                ...
                if (mRetPwd.getText().toString().trim().length() < 6 || mRetPwd.getText().toString().trim().length() > 20) {
                ...
                userRegister(mPhoneNum.getText().toString().trim(), mRetPwd.getText().toString().trim(), mCheckNum.getText().toString().trim());
     ...
     * @param checkNum
     */
    private void userRegister(final String phone, String pwd, String checkNum) {

        showLoadingDialog("正在请求……");

        RequestParams params = new RequestParams(WebUrl.REGISTERAPI);
